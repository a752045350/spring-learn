package com.springboot.learn.ExcelUtils;
...
public class ExportExcelUtils {
         ...
         * @throws IOException
         */
        public void excelExport(List list, String title, Class className, Integer exportType, HttpServletResponse response, HttpServletRequest request) throws Exception {
